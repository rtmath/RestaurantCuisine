...
namespace Food
{
  public class CuisineTest : IDisposable
  {
    ...
    // CODE APPARENTLY CAUSING BUG
    [Fact]
    public void Test_GetRestaurants_RetrievesAllRestaurantsInCuisine()
    {
      Cuisine testCuisine = new Cuisine("Banquet Frozen Goodies");
      testCuisine.Save();

      Restaurant firstRestaurant = new Restaurant("Banquet House", testCuisine.GetId());
      firstRestaurant.Save();
      Restaurant secondRestaurant = new Restaurant("Banquet Pot Pies Shack", testCuisine.GetId());
      secondRestaurant.Save();

      List<Restaurant> testRestaurantList = new List<Restaurant>{firstRestaurant, secondRestaurant};
      List<Restaurant> resultList = testCuisine.GetRestaurants();

      Assert.Equal(testRestaurantList, resultList);
    }
